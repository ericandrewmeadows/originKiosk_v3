                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                        <td align="center" style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly;" width="100%">
                                          <!-- <table border="0" cellpadding="0" cellspacing="0" class=<?php echo "card ".$brand_text;?>> -->
                                          <?php echo '<table border="0" cellpadding="0" cellspacing="0" class="card '.$brand_text.'">';?>
                                          <tbody>
                                            <tr class="card-light">
                                                <td class="card-type" style="border: 0; margin: 0; padding: 0; mso-line-height-rule: exactly;" valign="top">
                                                  <span class="retina">
                                                    <img alt="Visa" height="16" src="https://stripe-images.s3.amazonaws.com/emails/receipt_assets/card/visa-light@2x.png" style="border: 0; margin: 0; padding: 0;" width="36" />
                                                  </span>
                                                </td>
                                              ...
                                              <td class="card-digits" style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly; color: #ffffff; font-family: 'Lucida Console', monospace; font-size: 14px; line-height: 14px; text-shadow: 0 1px 1px #505050; vertical-align: middle;" valign="middle">
                                                <span style="color: #ffffff; font-family: 'Lucida Console', monospace; font-size: 14px; line-height: 14px;"><?php echo $last4;?></span>
                                              </td>
                                            </tr>
                                          </tbody>
                                        </table>
...
<?php
    file_put_contents(__DIR__."/receipts/".$phoneNumber."_".$timeSeconds.".html", ob_get_contents());
